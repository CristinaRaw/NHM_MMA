...
# Add weights. Reviews will have a wight of 1, and meta-analysis a 
...
m0 <- lmer(LRR ~ 1 + (1|Crop), weights = Weight, data = d)
plot(m0)

m <- blmer(LRR ~ Treatment + magpie_class + biodiveristy_metric_category + (1|Crop) + (1|ID), weights = Weight, data = d)
