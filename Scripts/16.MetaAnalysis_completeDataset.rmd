...
<!-- what can i do with species richness and abundance data ? -->
-   Plain species richness and abundance: calculate 
...
<!-- Check  how means are affected when doing them with % data m  -->

Since calculating the weighted mean with percentages can inflate results, I am going to transform the % change data that comes from LRR back to LRR applying the following formula. 
